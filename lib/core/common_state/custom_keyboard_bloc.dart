...
class CustomKeyboardBloc
  ...
  CustomKeyboardBloc()
      : super(CustomKeyboardInitial(
      textEditingController: TextEditingController(), length: 3)) {
  ...
  FutureOr<void> _setLength(
      SetKeyboardLengthEvent event, Emitter<CustomKeyboardState> emit) {
