    ...
    return Row(
      ...
      children: [
        Column(
          children: [
            CustomToggleButton(
              ...
              border:_gas91 ? Border.all(color: Colors.transparent, width: 0.7)
            ...
            CustomToggleButton(
              ...
              border:_diesel ? Border.all(color: Colors.transparent, width: 0.7)
                  : Border.all(color: AppColors.orderNumberColor, width: 0.7),
              onTap: (){
                setState(() {
                  _diesel =!_diesel;
        ...
        CustomToggleButton(
          ...
          border:_gas95 ? Border.all(color: Colors.transparent, width: 0.7)
              : Border.all(color: AppColors.orderNumberColor, width: 0.7),
          onTap: (){
            setState(() {
              _gas95 =!_gas95;
